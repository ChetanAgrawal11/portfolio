  ...
  return (
    <section id="skills">
      <div className="skills mt-[80px]  flex flex-col items-center">
        <div className="div1">
          <p className="text-white text-3xl  w-full font-bold mt-5">
            About me{" "}
          </p>
        </div>
        <div className="div2 flex flex-col w-full mt-[50px]">
          ...
          <p className="he text-gray-300 ml-[27%] mr-[10%]">
            Additionally, my repertoire extends to cross-platform development
            with frameworks like Flutter.
          </p>
        </div>
        <div className="div3 mt-[100px] flex gap-5">
          <div className="first flex ">
            <p className="text1 text-purple-200 text-4xl">2+ </p>
            <p className="text2 text-gray-500 mt-2 ml-2">
              Years of Web Experience
            </p>
          </div>
          <div className="first flex">
            <p className="text3 text-purple-200 text-4xl">100+ </p>
